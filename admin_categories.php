    ...
    <div class="row g-4">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="person-card">
                <?php if(!empty($row['image'])): ?>
                    <img src="<?= htmlspecialchars($row['image']) ?>" alt="<?= htmlspecialchars($row['name']) ?>" class="person-image">
                <?php else: ?>
                    <div class="person-image d-flex align-items-center justify-content-center" 
                        ...
                        <i class="fas fa-folder" style="font-size: 3rem; color: #ccc;"></i>
                    </div>
                <?php endif; ?>
                ...
                <a href="admin_edit_category.php?id=<?= $row['id'] ?>" class="detail-btn">
        ...
        <?php endwhile; else: ?>
            <div class="no-results">
                ...
                <div class="no-results-text">ยังไม่มีหมวดหมู่</div>
            </div>
        <?php endif; ?>
    </div>
</div>
